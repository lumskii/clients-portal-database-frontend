  ...
  return (
    ...
    <DashBoard>
      <Box m="80px 20px 20px 20px">
        ...
        {form && (
          <form className="form_exps" onSubmit={handleSubmit}>
        ...
        <div className="info_wrapper">
          ...
          <div className="published">
            ...
            <ul>
              <li>
                Date Expensed: <span>{details.dateExp}</span>
              </li>
              <li>
                Company Type: <span>{details.cType}</span>
              </li>
              <li>
                Description: <span>{details.describe}</span>
              </li>
              <li>
                Amount: <span>{details.amount}</span>
              </li>
            </ul>
          </div>
        </div>
