...
import { Box, Tabs, Tab, Typography, useMediaQuery, AppBar } from '@mui/material';
  ...
  return (
    <DashBoard>
      <Box m="80px 20px 20px 20px">
        <Header
          title="Sales Revenue"
          subtitle="Add/Edit Sales Revenue"
        />
        <Box
          display="grid"
          gap="30px"
        ...
        >
            ...
            <AppBar position="static" color="default" sx={{ gridColumn: "span 4" }}>
              <Tabs
                value={toggleState}
                ...
                <form className="form active-content" onSubmit={handleSubmit}>
                  ...
                  <div className="form-input">
                    ...
                    >
                      ...
                      <option value="united_states/canada">United States/Canada</option>
